/**
 * The above code is a JavaScript function that sends a welcome email to a user using Nodemailer.
 * @param user - The `user` parameter is an object that contains information about the user who will
 * receive the welcome email. It typically includes properties such as `name`, `email`, and `password`.
 */
...
async function sendWelcomeEmail(user) {
  try {
    ...
    const loginLinks = allowedOrigins
      .map((origin) => `- ${origin}/login`)
      .join("\n");
