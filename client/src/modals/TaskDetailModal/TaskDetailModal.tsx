...
import { Task, Comment, User } from "../../problemdomain/Interface/Interface";
    ...
    const fetchComments = async () => {
      try {
        const commentsResponse = await axios.get(
          `${config.backend}/api/projects/${projectId}/comments`
        );
        const taskComments = commentsResponse.data.filter(
