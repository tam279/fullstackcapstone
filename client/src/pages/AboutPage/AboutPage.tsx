                    ...
                    <Col md={6}>
                        <div className="about-facts">
                            ...
                            <ol type='1'>
                                ...
                                <li>Vitra Service also offers Information Management, Enterprise Content Management, Cloud Management, and Business Analytics services.</li>
                                <li>Expertise includes Project Management, Negotiation, Backup & Recovery Systems, Data Reporting, and 24/7 Technical Support.</li>
                                <li>Their goal is to simplify technology for businesses, ensuring operational excellence and growth.</li>
                                <li>Vitra Service is characterized by the meeting point of technology and innovation.</li>
                            </ol>
                        </div>
                    </Col>
                    <Col md={6}>
